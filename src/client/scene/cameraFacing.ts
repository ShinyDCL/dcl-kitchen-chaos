...
// facing rotation instead — set once, never re-evaluated.
...
/**
 * The fixed pitch of the mobile camera rig (platform/mobileCamera.ts),
 * positive tilting down. It lives here rather than with the camera because
